    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark px-3 px-md-5">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
            ...
            <form action="" class="d-flex">
                <button class="btn btn-sm btn-danger fw-bold lh-sm px-4 rounded-pill shadow-sm mx-auto mx-md-0 my-1 my-md-0" style="box-shadow: 0 .125rem .25rem rgba(13,110,253,.075)!important">Отправить<br>заявку</button>
            </form>
        </div>
    </nav>
</header>
